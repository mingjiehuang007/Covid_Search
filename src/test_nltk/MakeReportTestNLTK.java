...
public class MakeReportTestNLTK {
    // 该算法用nltk3.6.2进行分句

    private void combineFiles() throws Exception{

        String output_path = ".\\test\\final_output\\final_output.txt";
        try {
        ...
        File dir = new File(".\\test\\output1");            // ouput的存放地址
            ...
            if(!f.isFile()){
                ...
                for (File ff : list_of_files){
                    ...
                    while((line_temp = br.readLine()) != null){
                        ...
                        if (source_list.size() >= 10000){        // 满10000条就输出
    ...
    private void setDocPart1(String outputPath, String newPath) throws Exception{
        ...
        ArrayList<ArrayList<String>> keyword_list = this.getDiseaseName(".\\relations\\DiseaseInfo.txt");
    ...
    private void setDoc(String inputPath, String newPath) throws Exception{
        ...
        String docInfo_path = ".\\relations\\DocInfo.txt";
        ...
        while ((readLine = bufferedReader.readLine()) != null) {
            ...
            String doc_id_temp = line_arr[1];
            if (doc_id_temp.substring(0,3).equals("PMC")){
                doc_id_temp = pmc_doc_map.get(doc_id_temp);
            }
            if (line_arr.length >= 4) {
                line = line_arr[0] + "\t" + doc_id_temp + "\t" + line_arr[2] + "\t" + line_arr[3];
                lines_set.add(line);
            }
            count++;
            if(count%100000 == 0){
    ...
    public ArrayList<String> splitDocNLTK (String srcText){

        ArrayList<String> sen_list = new ArrayList<>();
        try {
            String[] args1 = new String[] { "python", ".\\Python\\SplitDoc.py", srcText};
    ...
    public void reportPart1(String test_file, String reportFileName) throws Exception{
        ...
        String diseaseInfo_path = ".\\relations\\DiseaseInfo.txt";
        String docInfo_path = ".\\relations\\DocInfo.txt";
        String covid_syn_path = "./data/relations/COVID-19_synonym";
        String doc_sen_path = ".\\test\\relations\\doc sen relations.txt";
...
//        }
        ...
        String indexPath2 = ".\\test\\indexOfOutput";
        ...
        FileWriter fw = new FileWriter(reportFileName, true);
        PrintWriter pw = new PrintWriter(fw);
            ...
            for (int i = 0; i < doc_id_list_set.size(); i++){
                ...
                if (flag) {
                    ...
                    for (ScoreDoc doc : scoreDocs) {
                        ...
                        ArrayList<String> abstract_list_temp = this.splitDocNLTK(abstract_temp);
                        ArrayList<String> body_text_list_temp = this.splitDocNLTK(body_temp);
                ...
                if(!flag) {
                    ...
                    for (ScoreDoc doc : scoreDocs) {
                        ...
                        ArrayList<String> body_text_list_temp1 = this.splitDocNLTK(body_temp);
    ...
    public static void main(String[] args) throws Exception {
        MakeReportTestNLTK makeReport = new MakeReportTestNLTK();
//        makeReport.combineFiles();
//        makeReport.combineJsonToText(".\\test\\text\\包含COV-19词汇_摘要", ".\\test\\json_to_text\\abstract_to_text.txt", "abstract");
//        makeReport.combineJsonToText(".\\test\\text\\包含COV-19词汇_正文", ".\\test\\json_to_text\\body_to_text.txt", "body_text");
//        makeReport.setDocPart1(".\\test\\final_output\\final_output.txt", ".\\test\\final_output\\final_output_set_temp.txt");
//        makeReport.setDoc(".\\test\\final_output\\final_output_set_temp.txt",".\\test\\final_output\\final_output_set.txt");
//        makeReport.createIndex(".\\json_to_text", ".\\index2");
//        makeReport.createIndexForOutPut(".\\test\\final_output\\final_output_set.txt", ".\\test\\indexOfOutput");
        makeReport.reportPart1(".\\test\\final_output\\final_output_set.txt",".\\test\\report\\test_report_nltk.txt");
    }
}
